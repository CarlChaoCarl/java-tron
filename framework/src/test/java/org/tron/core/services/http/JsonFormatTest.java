...
public class JsonFormatTest {
  ...
  public void testPrintErrorMsg() {
    ...
    Assert.assertEquals("{\"Error\":\"test\"}", out);
  }
  ...
  public void testUnsignedToString() throws Exception {
    String out1 = Whitebox.invokeMethod(JsonFormat.class, "unsignedToString", 100l);
    Assert.assertEquals("100", out1);
    String out2 = Whitebox.invokeMethod(JsonFormat.class, "unsignedToString", -100l);
    Assert.assertNotNull(out2);

    String out3 = Whitebox.invokeMethod(JsonFormat.class, "unsignedToString", 100);
    Assert.assertEquals("100", out3);
    String out4 = Whitebox.invokeMethod(JsonFormat.class, "unsignedToString", -100);
  ...
  public void testToStringBuilderWithNonReadableInput() throws Exception {
    ...
    Assert.assertEquals(inputString, out.toString());
  }
  ...
  public void testDigitValue() throws Exception {
    ...
    int out1 = Whitebox.invokeMethod(JsonFormat.class,
        "digitValue", input1);
    Assert.assertEquals(11, out1);

    char input2 = 'B';
    int out2 = Whitebox.invokeMethod(JsonFormat.class,
        "digitValue", input2);
    Assert.assertEquals(11, out2);
  }
  ...
  public void testParseInteger() throws Exception {
    ...
    Assert.assertThrows(
        ...
        () -> {
          Whitebox.invokeMethod(JsonFormat.class,
              "parseInteger", input5, false, true);
        }
    );
    ...
    Assert.assertThrows(
        ...
        () -> {
          Whitebox.invokeMethod(JsonFormat.class,
              "parseInteger", input2, false, true);
        }
    );
    ...
    Assert.assertThrows(
        ...
        () -> {
          Whitebox.invokeMethod(JsonFormat.class,
              "parseInteger", input3, false, false);
        }
    );
    ...
    Assert.assertThrows(
        ...
        () -> {
          Whitebox.invokeMethod(JsonFormat.class,
              "parseInteger", input4, true, false);
        }
    );
  }
